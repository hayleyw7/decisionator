...
Add the choices you are weighing (where to eat, what movie to watch, which task to tackle first) and let the app choose for you. It is meant for low-stakes decisions like picking dinner, weekend plans, a movie, or which small task to do next when you would rather not debate any longer.
